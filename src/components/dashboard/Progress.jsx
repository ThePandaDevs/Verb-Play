        ...
        <div className="grid grid-cols-1 md:grid-cols-2 py-5">
            ...
            >
                {count>0 ?
                    <>
                        ...
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                                ...
                                <h1 className="mb-5 text-6xl font-bold text-black">{count}</h1>
                                <p className="mb-5 text-black text-lg">You have added these verbs to your personal list</p>
                            </div>
                        </div>
                        </div>
                    </>
                    :
                    <>
                      <div className="w-auto mr-0 my-5 bg-base-100 image-full hero drop-shadow-[0_2px_2px_rgba(0,0,0,0.25)] rounded-[25px] md:mr-10">
                          <div className="hero-content text-center text-neutral-content">
                              <div className="max-w-md">
                                  <h1 className="mb-5 text-3xl font-semibold text-black z-40 ">¡Oh no!</h1>
                                  <h1 className="mb-3 text-6xl font-bold text-black">{count}</h1>
                                  <p className="mb-5 text-black text-lg">You have not added any verbs to your list yet</p>
                              </div>
                          </div>
                      </div>
                    </>
                ...
                <div className="p-5 w-auto my-5 bg-base-100 drop-shadow-[0_2px_2px_rgba(0,0,0,0.25)] rounded-[25px]">
                    ...
                    <div className="grid grid-cols-1">
                        <div className="flex items-center justify-around ">
                            ...
                            <progress className="progress progress-success" value={G1.toString()} max="100"></progress>
                            <h1 className="text-center mx-3 text-[#00BFA6]">{G1}%</h1>
                        </div>
                        <div className="flex items-center justify-around">
                            <svg className="w-12 h-12" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h1 className="text-center mx-3">Group</h1>
                            <progress className="progress progress-warning" value={G2} max="100"></progress>
                            <h1 className="text-center mx-3 text-[#FABE2C]">{G2}%</h1>
                        </div>
                        <div className="flex items-center justify-around">
                            <svg className="w-12 h-12" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <progress className="progress progress-primary" value={G3} max="100"></progress>
                            <h1 className="text-center mx-3 text-[#6C63FF]">{G3}%</h1>
                        </div>
                    </div>
                </div>
            </motion.div>
