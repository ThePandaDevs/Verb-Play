                ...
                <div className="p-5 w-auto my-5 bg-base-100 drop-shadow-[0_2px_2px_rgba(0,0,0,0.25)] rounded-[25px]">
                    ...
                    <div className="grid grid-cols-1">
                        <div className="flex items-center justify-around ">
                            ...
                            <progress className="progress progress-success animate-pulse" value="78" max="100"></progress>
                        ...
                        <div className="flex items-center justify-around">
                            ...
                            <h1 className="text-center mx-3">Group</h1>
                            <progress className="progress progress-warning animate-pulse" value="56" max="100"></progress>
                        ...
                        <div className="flex items-center justify-around">
                            ...
                            <progress className="progress progress-primary animate-pulse" value="30" max="100"></progress>
