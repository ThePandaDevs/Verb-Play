export const LeftContentLogin = () => {
    return (
        <div className="p-3 pt-1/2">
            ...
            <div className="flex justify-center mt-6">
                <a href="/dashboard" className="btn btn-ghost bg-[#00A67E] hover:bg-[#00A67E] text-white border-none drop-shadow-[0_5px_0px_rgba(0,0,0,0.25)] active:drop-shadow-none -translate-y-0  w-full max-w-xs">Iniciar Sesión</a>
            </div>
