    ...
    return (
        <>
            <div className="flex basis-2/5 flex-col bg-[#00A67E] rounded-lg drop-shadow-lg">
                ...
                <p className="text-xl font-bold text-[#ffff] mt-10">Esmeralda Lara Arroyo</p>
                <p className="text-lg text-[#ffff]">@esmeLara</p>
                <div className="flex flex-row justify-around">
                    <div className="flex-col">
                        <p className="text-xl font-bold text-[#ffff] mt-10">Location</p>
                        <p className="text-lg text-[#ffff]">Mexico</p>
                    </div>
                    <div className="flex-col">
                        <p className="text-xl font-bold text-[#ffff] mt-10">Birthday</p>
                        <p className="text-lg text-[#ffff]">27/05/2001</p>
                    </div>
                </div>
