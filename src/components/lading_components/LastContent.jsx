      ...
      <div>
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-3 p-6">
              <div className="grid place-items-center shadow rounded-lg p-6 m-2 bg-white">
                  ...
                  <button className="btn btn-ghost btn-wide bg-white text-black mt-4 mx-2 drop-shadow-[0_5px_0px_rgba(0,0,0,0.25)] active:drop-shadow-none -translate-y-0">Choose plan</button>
              </div>
