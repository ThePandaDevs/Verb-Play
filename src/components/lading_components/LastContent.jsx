    ...
    return (
        <div className="h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 p-6 ">
                <div className="grid place-items-center shadow-md rounded-[30px] p-6 m-2 bg-white">
                    ...
                    <div className="mt-2">
                        <div className="flex mt-3">
                            ...
                            <p className="landing-text font-light text-sm ml-3 flex items-center">1 day trial</p>
                        </div>
                        <div className="flex mt-3">
                            <img src={CheckIMG} className="w-6" />
                ...
                <div className="grid place-items-center shadow-md rounded-[30px] p-6 m-2 bg-white">
                    ...
                    <div className="flex mt-2">
                        ...
                        <p className="mt-2 landing-text font-light text-2xl text-center">/Monthly</p>
                    </div>
