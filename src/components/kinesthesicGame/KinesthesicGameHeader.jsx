        ...
        <>
            <div className="p-5 justify-center md:flex justify-between  w-full bg-base-100 drop-shadow-[0_2px_2px_rgba(0,0,0,0.25)] rounded-[25px] md:grid-cols-2 ">
                <div className="flex justify-center md:justify-start ">
                    <div className="grid">
                        <h3 className="font-bold text-black text-lg">Write english verbs according with spanish meaning </h3>
                        <p className="font-normal text-center md:text-left lg:text-left">If you can’t complete them continue with the next</p>
                    </div>
                </div>
...
export default KinesthesicGameHeader;